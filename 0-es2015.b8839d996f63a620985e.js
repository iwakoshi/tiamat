...
let BuilderRoutingModule = class BuilderRoutingModule {
};
...
let PaletteComponent = class PaletteComponent {
    constructor(elementService, compiler) {
    ...
    ngAfterViewInit() {
        this.viewElements.changes.subscribe((change) => {
    ...
    loadComponent(containers) {
        setTimeout(() => {
            const components = [];
            const tmpModule = Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({ imports: [src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"]], declarations: components })(class {
            });
            containers.forEach((container, index) => {
                console.log('element [' + index + '] ::');
                components.push(Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({ template: container.element.content })(class {
                }));
            });
...
let WindowComponent = class WindowComponent {
    ...
    createElement(element) {
        const components = [Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({ template: element })(class {
            })];
        const tmpModule = Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({ imports: [src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_2__["SharedModule"]], declarations: components })(class {
        });
        this.compiler.compileModuleAndAllComponentsAsync(tmpModule)
            .then((factories) => {
